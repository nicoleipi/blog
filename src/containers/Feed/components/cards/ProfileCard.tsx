...
const ProfileCard: React.FC<Props> = ({ className }) => {
  return (
    <div className={className}>
      ...
      <div className="rounded-2xl bg-white dark:bg-blue w-full md:p-4 lg:p-4 mb-9">
        <div className="relative w-full after:content-[''] after:block after:pb-[100%]">
          <Image src={CONFIG.profile.image} layout="fill" alt="" />
        </div>
        <div className="bg-white p-2 flex flex-col items-center dark:bg-blue dark:text-white">
