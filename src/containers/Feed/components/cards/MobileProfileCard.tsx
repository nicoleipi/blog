...
const MobileProfileCard: React.FC<Props> = () => {
  return (
    <div className="block lg:hidden">
      ...
      <div className="p-2 rounded-2xl bg-white dark:bg-blue mb-4">
        ...
        {/* <div className="flex">
          {CONFIG.profile.github && (
            <a
              ...
              rel="noreferrer"
              target="_blank"
              className="p-3 dark:hover:bg-blue rounded-2xl cursor-pointer text-gray-500 dark:text-white "
            >
          ...
          {CONFIG.profile.email && (
            <a
              ...
              rel="noreferrer"
              target="_blank"
              className="  overflow-hidden p-3 dark:hover:bg-blue rounded-2xl cursor-pointer text-gray-500 dark:text-white"
            >
