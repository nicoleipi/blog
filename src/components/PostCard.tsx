  ...
  return (
    <Link href={`/${data.slug}`}>
      <a>
        <article
          key={data.id}
          className="relative overflow-hidden mb-6 md:mb-8 rounded-2xl bg-white dark:bg-blue hover:shadow-lg transition-shadow "
        >
          {category && (
          ...
          {data.thumbnail && (
            <div className="relative w-full pb-[66%] lg:pb-[50%] bg-gray-200 dark:bg-blue ">
              <Image
                src={data.thumbnail}
